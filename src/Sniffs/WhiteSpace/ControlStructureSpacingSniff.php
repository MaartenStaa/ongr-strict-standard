...
class ControlStructureSpacingSniff implements Sniff
{
    ...
    public function process(File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($tokens[$trailingContent]['scope_condition']) === true
            ...
            if ($tokens[$trailingContent]['line'] !== ($tokens[$scopeCloser]['line'] + 1) && $tokens[$trailingContent]['code'] !== T_RETURN) {
        ...
        //ONGR We do not require blank line after the control structure.
