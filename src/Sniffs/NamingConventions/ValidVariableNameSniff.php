...
namespace MaartenStaa\OngrStrictStandards\Sniffs\NamingConventions;
...
class ValidVariableNameSniff extends AbstractVariableSniff
{
    ...
    {
        //ONGR skipping variable checking
...
//        }
    ...
    protected function processMemberVar(File $phpcsFile, $stackPtr)
    {
        ...
        //ONGR We do not require private member variable containg a leading underscore.
//        else {
//            if (substr($varName, 0, 1) !== '_') {
...
//        }
    ...
    {
        //ONGR skipping variable in string checking
//        $tokens = $phpcsFile->getTokens();
//
//        $phpReservedVars = array(
//            '_SERVER',
